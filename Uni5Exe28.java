...
public class Uni5Exe28 {
    public static void main(String[] args) {
        ...
        // Variáveis para armazenar os votos de cada conjunto
        ...
        while (continuar == 's' || continuar == 'S') {
            ...
            // Pergunta se deseja continuar votando
            System.out.print("Mais um voto: s (SIM) / n (NÃO)? ");
            continuar = teclado.next().charAt(0); // Atualiza a variável continuar
        }

        // Verifica se houve votos e exibe os resultados
        if (totalVotos > 0) {
            // Exibe o total de votos para cada grupo
            System.out.println("\nTotal de votos:");
            ...
            // Calcula e exibe o percentual de votos para cada grupo
            System.out.printf("Percentual de votos para Nenhum de Nós: %.2f%%%n", (votosNenhumDeNos * 100.0 / totalVotos));
